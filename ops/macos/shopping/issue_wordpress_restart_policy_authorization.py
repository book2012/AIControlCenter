"""Separate interactive 01G1F0 issuer; issuance never executes the mutation."""
...
from core.shopping.wordpress_restart_policy_authorization import WordPressRestartPolicyAuthorization, immutable_contract
from core.shopping.wordpress_restart_policy_reconciliation import MUTATION_ID, MUTATION_ARGS, canonical_snapshot, projection
from ops.macos.shopping.wordpress_restart_policy_authorization_store import WordPressRestartPolicyAuthorizationStore
from ops.macos.shopping.wordpress_restart_policy_operator import observe_preconditions
...
def issue():
    ...
    WordPressRestartPolicyAuthorizationStore._initialize_for_issuer()._issue(authorization)
