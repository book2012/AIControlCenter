...
from core.shopping.wordpress_generation_authorization import (
...
APPLICATION_ID = 0x57473143
USER_VERSION = 1
_COMPONENTS = ("Library", "Application Support", "AIControlCenter", "authorization", "wordpress-generation-01g1c-authorization.sqlite3")
...
CREATE TABLE wordpress_mutation_authorizations (
 ...
 authoritative_work_item TEXT NOT NULL CHECK(authoritative_work_item='SHOP-SERVICE-START-01G1C'),
 environment TEXT NOT NULL CHECK(environment='CONTROLLED_NON_PRODUCTION'),
 mutation_id TEXT NOT NULL CHECK(mutation_id='SHOP-SERVICE-START-01G1C:WORDPRESS_RUNTIME_GENERATION_RECONCILIATION'),
...
class WordPressGenerationAuthorizationStore:
    ...
    def _consume(self, progress, observe):
        ...
        try:
            with self._write() as db:
                ...
                from core.shopping.wordpress_generation_reconciliation import canonical_snapshot
...
__all__=("WordPressGenerationAuthorizationStore","WordPressAuthorizationStoreError")
