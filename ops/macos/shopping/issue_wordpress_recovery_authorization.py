"""Separate interactive 01G1D issuer; issuance never executes the mutation."""
...
from core.shopping.wordpress_recovery_authorization import WordPressMutationAuthorization, immutable_contract
from core.shopping.wordpress_recovery_reconciliation import MUTATION_ID, canonical_snapshot, projection
from ops.macos.shopping.wordpress_recovery_authorization_store import WordPressRecoveryAuthorizationStore
from ops.macos.shopping.wordpress_recovery_operator import observe_preconditions
...
def issue():
    ...
    WordPressRecoveryAuthorizationStore._initialize_for_issuer()._issue(authorization)
