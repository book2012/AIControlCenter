...
## Completed locally — WordPress port source-value guard

- [x] Under `SHOP-SERVICE-START-01B`, require exact `58082` source evidence for
  both initial and post-authorization WordPress reconciliation.
- [x] Fail closed for wrong, malformed, missing, or duplicate port assignments.
- [x] Keep DB password and root-password values out of retained and public
  evidence.
- [x] Preserve strict UTF-8 syntax validation for their assignment records;
...
- [ ] In a separately authorized operation, observe the live source before any
  runtime action. No live state or cutover is claimed here.
